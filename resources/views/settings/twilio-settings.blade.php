...
@section('content')
    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs" role="tablist" >
            <li class="nav-item"> <a class="nav-link" data-toggle="tab" style="display: none" href="#stripe" role="tab">
                    <span class="hidden-sm-up"><i class="fa fa-stripe"></i></span>
                    <span class="hidden-xs-down">Stripe</span></a>
            </li>
            @if(auth()->user()->type == 'admin')
                <li class="nav-item"> <a class="nav-link active show" data-toggle="tab" href="#twilio" aria-selected="true" role="tab" >
                        <span class="hidden-sm-up"><i class="fa fa-stripe"></i></span>
        ...
        <div class="tab-content tabcontent-border">
            @if(auth()->user()->type == 'admin')
                <div class="tab-pane pt-20" id="twilio" role="tabpanel"  style="display: block">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="tab-pane active p-20" id="stripe" role="tabpanel" style="display: none">
                <div class="row">
